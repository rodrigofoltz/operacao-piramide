...
1. Faça o clone deste repositório:
   `git clone https://github.com/rodrigofoltz/operacao-piramide.git`
...
Através do desafio de criar um jogo de matemática para apresentar a turma (em papel), me empolguei e decidi criar um jogo web, para trazer imersão aos usuários/colegas e para meu aprendizado.
